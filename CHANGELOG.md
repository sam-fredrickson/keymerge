...
### Added
- `cfgmerge`: add `-out` flag to set output file explicitly
...
### Added
- `cfgmerge` standalone CLI program
...
[Unreleased]: https://github.com/sam-fredrickson/keymerge/compare/v0.3.1...HEAD
